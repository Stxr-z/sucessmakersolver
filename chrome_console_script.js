/**
 * SuccessMaker Solver - Chrome Console/DevTools Version
 * 
 * Usage: Copy and paste this entire script into Chrome DevTools Console (F12)
 * and press Enter. The Solve! button and stats panel will appear on the page.
 */

(async function() {
    'use strict';

    console.log('🚀 SuccessMaker Solver loaded! Initializing...');

    // Configuration - Using local Ollama
    const LLM_API_URL = 'http://localhost:11434/api/generate';
    const LLM_MODEL = 'llava';
    ...
    addSolverButton();
    console.log('✓ SuccessMaker Solver ready!');
